...
const rawSubject = "☕ Coffee Roulette: You've been matched with \${partnerName}!";
...
<head>
  <style>
    ...
    .partner-card { background: #f8f9fa; border-left: 4px solid #667eea; padding: 20px; margin: 20px 0; border-radius: 5px; }
    .partner-card h2 { margin-top: 0; color: #667eea; }
    .partner-info { margin: 10px 0; }
    .partner-info strong { color: #555; }
    .icebreakers { background: #fff3cd; border-left: 4px solid #ffc107; padding: 20px; margin: 20px 0; border-radius: 5px; }
    .icebreakers h3 { margin-top: 0; color: #856404; }
...
<body>
  ...
  <div class="content">
    ...
    <div class="partner-card">
      ...
      <div class="partner-info"><strong>Name:</strong> \${partnerName}</div>
      <div class="partner-info"><strong>Email:</strong> <a href="mailto:\${partnerEmail}">\${partnerEmail}</a></div>
      <div class="partner-info"><strong>Department:</strong> \${partnerDepartment}</div>
      <div class="partner-info"><strong>Scheduled:</strong> \${meetingDate}</div>
    </div>
    ...
    <ol>
      ...
      <li><strong>Schedule a time:</strong> Find a 30-minute slot that works for both of you</li>
...
const rawText = `Coffee Roulette: You've been matched with \${partnerName}!
...
2. Schedule a time: Find a 30-minute slot that works for both of you
