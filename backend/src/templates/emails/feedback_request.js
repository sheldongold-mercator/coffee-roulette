...
const rawSubject = "📝 How was your coffee with \${partnerName}?";
...
<head>
  <style>
    ...
    .feedback-card { background: #f1f8ff; border-left: 4px solid #2196f3; padding: 20px; margin: 20px 0; border-radius: 5px; }
...
const rawText = `How was your coffee with \${partnerName}?
